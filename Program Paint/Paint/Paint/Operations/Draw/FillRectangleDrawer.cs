...
{
    class FillRectangleDrawer:ADrawable
    {
        ...
        public override void Draw()
        {
            ...
            _drawingFeatures.Graphics.FillRectangle(_drawingFeatures.Pencil.Brush ,topLeftCorner.X, topLeftCorner.Y, rectangleWidth, rectangleHeight);
